...
// GeneratePlist generates and downloads a plist configuration file
func GeneratePlist(c *gin.Context) {
	...
	c.Header("Content-Disposition", fmt.Sprintf("attachment; filename=%s.plist", machineID))
